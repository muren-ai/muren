...
const WORLDS: World[] = [
  {
    ...
    shots: [
      ["THE THRESHOLD", "4:5", "/assets/resume.png"],
      ["PRODUCT UI", "16:10", "/assets/skill-assessment.png"],
      ["THE FLOOR", "16:10", "/assets/v-lab.png"],
    ],
  ...
  },
  {
    ...
    shots: [
      ["CARBON STOCK", "1475×1067", "/assets/carbon.png"],
      ["EMISSIONS", "1811×868", "/assets/emissions.png"],
      ["RIVER FLOW", "1380×1140", "/assets/flow.png"],
    ],
